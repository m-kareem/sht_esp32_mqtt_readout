...
const bool multiSensor=true; // true if there are multiple sensors connected via I2C, false otherwise
//const char *device_location="YorkLab"; // Where the device is located?
const char *device_name="esp32_2"; // Give the device a name!
...
//-------------MQTT topics --------------------
#define MQTT_TOPIC_STATE "YorkLab/esp32_2/status"
const char *MQTT_TOPIC_HUMIDITY= "YorkLab/esp32_2/measurements/rH";
const char *MQTT_TOPIC_TEMPERATURE= "YorkLab/esp32_2/measurements/T";
